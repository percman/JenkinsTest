        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./AssociateHome.jsp"> Home <span
                            class="sr-only">(current)</span></a>
                </li>

                <li class="nav-item dropdown">

                    <a class="nav-link dropdown-toggle" href="#" id="reimbursementDropdownMenuLink" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        Reimbursement
                    </a>

                    <div class="dropdown-menu" aria-labelledby="reimbursementDropdownMenuLink">

                        <form id=viewMyReimbursement action="./myReimbursement.do" method="post">
                            <a class="dropdown-item" onclick="document.getElementById('viewMyReimbursement').submit();" href="#">View Reimbursements</a>
                        </form>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <h1 class="display-4">Greetings Associate, <%=employee.getFirstName()%> <%=employee.getLastName()%>!</h1>
