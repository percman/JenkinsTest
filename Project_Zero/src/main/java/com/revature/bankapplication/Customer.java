...
public class Customer extends User implements Serializable{
	...
	public Customer(String username, String password, int approvalCode, int lockCode, boolean rejected, BigDecimal accountBalance) {
		super();
		this.username = username;
		this.password = password;
	...
	//Constructor for getting users
	public Customer(int customerId, String username, String password, int approvalCode, int lockCode, boolean rejected, BigDecimal accountbalance) {
		super();
