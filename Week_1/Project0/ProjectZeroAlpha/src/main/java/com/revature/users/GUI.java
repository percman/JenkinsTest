...
import static com.revature.users.SerializationOfUsers.hashMapUserData;
...
public class GUI{
	...
	public static void mainMenu(HashMap<Integer, User> userHashData, String currentUser) {
		...
		int inputnum = inputObject.intValue();
		...
		while(inputnum > 6 || inputnum < 1) {
    		...
    		String withdrawnLine = aquireLine();
