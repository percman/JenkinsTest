...
--Function to count the number of pending users--UNDER DEVELOPMENT
CREATE OR REPLACE FUNCTION get_number_of_pending_users(approved COLUMN) RETURN NUMBER
AS
    pending_users NUMBER;
BEGIN
    SELECT COUNT(approved)INTO pending_users FROM dual;
