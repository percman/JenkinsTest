...
public class ListOfUsers {
	...
	// This will return the number of items in the list with isApproved set to 1 or
	// pending
	...
	public static void deserializeUsers() {
		...
		try (ObjectInputStream input = new ObjectInputStream(
			...
			logger.trace("Deserialization complete...");
		} catch (IOException ioe) {
			logger.warn("There was an error reading user information from the system.");
		} catch (ClassNotFoundException cnfe) {
			logger.warn("There was an error getting user class information from the system.");
		}*/
	}
	...
	public static void serializeUsers() {
		...
		try (ObjectOutputStream output = new ObjectOutputStream(
			...
			logger.warn("There was an error storing user information to the system.");
		}*/
	}
