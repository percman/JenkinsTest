...
public class UserCreation {
	...
	public static void createUser() {
		...
		newUser.setFirstName(Initialization.input.next());
		System.out.print("Please enter your last name: ");
		newUser.setLastName(Initialization.input.next());
		System.out.print("Please create a username: ");
			
		// Check if the username already exists
		String username = Initialization.input.next();
		while (ListOfUsers.usernameExists(username)) {
			System.out.println("\n\t\t" + username + " already exists. \n\nPlease try another username: ");
			username = Initialization.input.next();
		}
		newUser.setUsername(username);
		
		// Collect more information
		System.out.print("Please set your password: ");
		newUser.setPassword(Initialization.input.next());
