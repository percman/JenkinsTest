...
public class UserLogin {
	...
	public static void checkCredentials() {
		...
		String aCasualString = Initialization.input.next() + Initialization.input.nextLine();
		if (aCasualString.equals("MY INSTRUCTORS ARE SO COOL")) {
			System.out.println("Yes, yes they are");
			Initialization.logger.trace("Nothing suspicious happened here...");
		...
		if (!Initialization.input.next().equals(currentUser.getPassword())) {
		...
		if (currentUser.getAdmin()) {
			if (currentUser.isLocked()) {
				...
				Initialization.logger.trace("Administator logged in: " + currentUser.getFirstName() + " " + currentUser.getLastName());
			...
			if (currentUser.isLocked()) {
				...
				Initialization.logger.trace("User logged in: " + currentUser.getFirstName() + " " + currentUser.getLastName());
