...
public class OtherReimbursement implements Reimbursement, Serializable{
	
	private static final long serialVersionUID = -8300446718806658304L;
	private int id;
...
//	private String info;
	...
	public OtherReimbursement(int id, double amount, int requestor_id, String status,
	...
	public OtherReimbursement(int id, double amount, String category, int requestor_id, int approver_id,
	...
	public String toString() {
		return "OtherReimbursement [id=" + id + ", amount=" + amount + ", category=" + category + ", requestor_id="
