...
public class TravelReimbursement implements Reimbursement, Serializable{

	private static final long serialVersionUID = -1229014310073552940L;
	private int id;
...
//	private Date enddate;
	...
	public TravelReimbursement(int id, double amount, String category, int requestor_id, int approver_id,
	...
	public String toString() {
		return "TravelReimbursement [id=" + id + ", amount=" + amount + ", category=" + category + ", requestor_id="
