...
public class TravelReimbursement extends Reimbursement{
	...
	public TravelReimbursement(int id, double amount, int requestor_id, boolean status) {
		super(id, amount, requestor_id, status);
	}	
	
	public TravelReimbursement(int id, double amount, int requestor_id, boolean status, String streetaddress,
	...
	public TravelReimbursement(int id, double amount, int requestor_id, int approver_id, boolean status,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TravelReimbursement other = (TravelReimbursement) obj;
		if (city == null) {
			if (other.city != null)
				return false;
	...
	public String toString() {
		return "TravelReimbursement [streetaddress=" + streetaddress + ", city=" + city + ", state=" + state
