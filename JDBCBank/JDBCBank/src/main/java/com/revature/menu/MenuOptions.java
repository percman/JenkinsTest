...
public class MenuOptions {
	...
	public static User getAdminMenuOptions(int choice, User currentUser) {
		...
		switch(choice) {
	        ...
	        case 4: choice = 4;
				...
				if(userApproval.equals(currentUser.getUsername())) {
					System.out.println("You can't reject yourself. Believe in yourself!");
					break;
				}
	        ...
	        case 5: choice = 5;
				...
				if(userLocked.equals(currentUser.getUsername())) {
					System.out.println("You can't lock yourself!");
					break;
				}
	...
	public static void getBankMenuOptions(int choice, User currentUser) {
		...
		switch(choice) {
			...
			case 1: choice = 1;
				System.out.println("The current balance is: $" + df.format(currentUser.getBalance()));
			break;
			...
			case 2: choice = 2;
				...
				System.out.println("The new balance is: $" + df.format(currentUser.getBalance()));
