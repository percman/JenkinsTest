...
//		(user.getPassword().equals(UserDaoImpl.getInstance().getPasswordHash(new User("username", "password")))));
...
//		System.out.println("Was the pokemon successfully added to the user? " + UserService.addPokemon("Squirtle", "username"));
		
		for (Pokemon p : UserService.getAllPokemon("username")) {
			System.out.println(p);
		}
		
		for (User u : PokemonService.getUsers("Charmander")) {
