...
<body>
	...
	<form action="/SecondDayServlets/FormProcessingServlet" method="POST">
		...
		<input type="password" name="password"
			placeholder="Please enter password"><br> <label
			for="email">Email</label> <input id="email" type="radio"
			name="contact" value="Email"> <label for="phone">Phone</label>
		<input id="phone" type="radio" name="contact" value="Phone"> <label
			for="msg">Text Message</label> <input id="msg" type="radio"
			name="contact" value="Text MSG"> <input type="submit"
			value="Submit Form">
	</form>
	<br>
	<br>
	...
	<form>
		...
		<input type="text" name="name" id="pokemonName"
			placeholder="Please enter a Pokemon Name">

		<!-- Added the id so we can get the text content of the input using JavaScript -->
		<input type="text" name="type" id="pokemonType"
			placeholder="Please enter the Pokemon Type">
