...
DROP TRIGGER employee_information_b_insert;
...
CREATE OR REPLACE PROCEDURE insert_reimbursement(new_r_id IN NUMBER, new_category IN NUMBER, new_amount IN NUMBER, new_message VARCHAR2, new_status IN NUMBER)
AS
BEGIN
...
SELECT * FROM financial_manager WHERE employee_id = 42;
