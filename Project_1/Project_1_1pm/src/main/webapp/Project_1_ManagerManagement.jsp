...
<body style="background-color: rgb(105, 120, 245)">
	...
	<div class="container">
		...
		<ul class="navbar-nav nav col-md-5">
			...
			<li class="active"><a href="./Project_1_ManagerManagement.jsp">Management</a></li>
	...
	<div class="container well"
		...
		<div class="container col-md-5">
			...
			<div>
				<p>
					View by: <select class="btn btn-info" required name="employee"
						id="employeeSelector">
...
<input type="text" required disabled value="Manager ID: <%=manager.getManager_id()%>">
<input type="text" required disabled value="Requestor ID: ">
<input type="text" required disabled value="Reimbursement ID: ">

<input class="btn btn-success" type="submit" id="approveRequest"
						value="Approve Request" style="width:200px" onclick="approveUser()">


<input class="btn btn-danger" type="submit" id="denyRequest"
						value="Deny Request" style="width:200px" onclick="denyUser()">
