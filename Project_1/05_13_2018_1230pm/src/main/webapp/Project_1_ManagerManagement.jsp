<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	%>
	        <%@ page import="com.revature.image.Image"%>
            <%
                ...
                <div id="abc">
                    <div id="popupContact">
                        ...
                        <form action="popupApproveReimbursement.do" id="form" method="GET" name="form">
                            ...
                            <hr>
                            <div>
                            <input class="form-control" id="hidden_blob" type="text" name="blob" value=<%=image.getBlobBytes()%>>
                        </div>
                            <img src="" id="image" alt="No receipt available">
                            ...
                            <label type="text" name="approve_request">Approve</label>
                            <input type="radio" name="request_radio" value=1 required>
                            <label type="text" name="deny_request">Deny</label>
                            <input type="radio" name="request_radio" value=-1>
                            <hr>
                            </div>

                            <input class="btn btn-success" type="submit" id="approveRequest" value="Submit" style="width:200px" onclick="approveUser()">
