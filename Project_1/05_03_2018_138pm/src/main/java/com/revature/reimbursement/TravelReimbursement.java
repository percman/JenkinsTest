...
public class TravelReimbursement implements Reimbursement{
	...
	public TravelReimbursement(int requestor_id, int approver_id, int category, float amount, Date requestDate,
			Date approveDate) {
		super();
	...
	public String toString() {
		return "TravelReimbursement [requestor_id=" + requestor_id + ", approver_id=" + approver_id + ", amount="
