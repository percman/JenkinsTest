...
public class OtherReimbursement implements Reimbursement{
	...
	public OtherReimbursement(int requestor_id, int approver_id, int category, float amount, Date requestDate,
			Date approveDate) {
		super();
	...
	public String toString() {
		return "OtherReimbursement [requestor_id=" + requestor_id + ", approver_id=" + approver_id + ", amount="
