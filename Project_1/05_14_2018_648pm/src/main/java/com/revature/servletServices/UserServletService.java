...
public class UserServletService {
	...
	public static String mUpdateUser(HttpServletRequest request, HttpServletResponse response) {
		Manager employee = new  Manager();
		String id = request.getParameter("employee_id");
		
		employee = ManagerService.getManager(Integer.parseInt(id));
