...
public class MasterDispatcher {
	...
	public static String process(HttpServletRequest request, HttpServletResponse response) {
		...
		case "/Project_1/submitManagerRequest.do": return ReimbursementServletService.mSubmit(request, response);
		...
		case "/Project_1/managerRequest.do": return ManagerServletService.request(request, response);
		case "/Project_1/managerAccount.do": return ManagerServletService.account(request, response);
		case "/Project_1/managerUpdate.do": return UserServletService.mUpdateUser(request, response);
		default:{
